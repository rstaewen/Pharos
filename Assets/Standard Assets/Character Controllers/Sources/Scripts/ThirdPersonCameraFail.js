...
private var overShoulder : Transform;
...
function Apply (dummyTarget : Transform, dummyCenter : Vector3)
{
	...
	var originalTargetAngle = _target.eulerAngles.y+180;
	...
	if (snap)
	{
		...
		if (AngleDistance (currentAngle, originalTargetAngle) < 3.0 && Input.GetButton("Fire2"))
		{
